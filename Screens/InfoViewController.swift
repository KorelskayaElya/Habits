...
class InfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        contantView.addSubview(textLabel)
        contantView.addSubview(textLabel1)
        contantView.addSubview(textLabel2)
        contantView.addSubview(textLabel3)
        contantView.addSubview(textLabel4)
        contantView.addSubview(textLabel5)
        contantView.addSubview(textLabel6)
        contantView.addSubview(textLabel7)
        contantView.addSubview(textLabel8)
        infoConstraint()
    }
    // MARK: - Private
